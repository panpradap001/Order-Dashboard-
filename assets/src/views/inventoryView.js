...
export function loadInventoryAdjustments() {
  if (inventoryUnsubscribe) {
    inventoryUnsubscribe(); // Unsubscribe previous listener to prevent memory leaks and fix re-login bugs
  }
...
function generateInventoryReport() {
  ...
  reportHtml += `<style>
    @media print {
      ...
      /* Hide all irrelevant sections */
      #app-sidebar, .mobile-header, #inventory-header { display: none !important; }
      .view-section:not(#view-inventory) { display: none !important; }
      #inventory-list-view, #inventory-form-view { display: none !important; }
      #inventory-report-view > div:not(#report-results-container) { display: none !important; }
      
      /* Make main container span full width */
      .main-content, .app-container { margin: 0 !important; padding: 0 !important; width: 100% !important; max-width: none !important; }
      ...
      .printable-report table { page-break-inside: auto; width: 100%; border-collapse: collapse; }
      ...
      .printable-report th { font-size: 9px !important; padding: 2px 1px !important; border-bottom: 1px solid #000 !important; }
      .printable-report td { font-size: 9px !important; padding: 2px 1px !important; }
      .printable-report h3 { font-size: 13px !important; margin-bottom: 4px !important; }
      .printable-report p { font-size: 9px !important; margin-bottom: 6px !important; line-height: 1.3 !important; }
      .printable-report td span { font-size: 9px !important; }
      .printable-report > div { margin-bottom: 8px !important; } 
      .printable-report div[style*="font-size: 1.1rem"] { font-size: 10px !important; margin-bottom: 2px !important; font-weight: bold; }
